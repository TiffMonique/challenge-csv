...
const Hero = () => {
  ...
  return (
    <div
      className="max-w-screen-xl mt-24 px-8 xl:px-16 mx-auto xs:mb-14"
      id="about"
    >
      <ScrollAnimationWrapper>
        <motion.div
          ...
          <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1 sm:col-span-1">
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-medium text-black-600 leading-normal">
              Make CSV import and export a breeze with  <strong>EasyConnect</strong>.
            </h1>
          ...
          <div className="flex w-full justify-center items-center sm:col-span-1">
            <motion.div className="xs:w-10/12 md:w-9/12" variants={scrollAnimation}>
              <Image
                src={csvimage}
